                                ...
                                <div className="grid  align-content-center align-item-center">
                                    <div className="flex w-full gap-3">
                                        ...
                                        <div className="field w-full">
                                            ...
                                            <InputNumber
                                                value={formData.current.price[index]}
                                        ...
                                        <div className="field w-full">
                                            ...
                                            <InputNumber
                                                value={formData.current.validity[index]}
                                                onValueChange={(e: InputNumberValueChangeEvent) => {
                                                    e.stopPropagation();
                                    ...
                                    <div className="w-full flex align-items-center gap-3">
                                        <div key={'desc' + index.toString() + Math.random()} className="w-full">
                                            <label htmlFor="desc">Description</label>
                                            <TextAreaField
                                                value={formData.current.description[index]}
                                                onChange={(val: string) => {
                                        ...
                                        {index != 0 && index == formData.current.price.length - 1 && (
                                            <Button
                                                className="w-fit p-2"
                                                onClick={() => {
...
const TextAreaField: React.FC<{ value: string; onChange: (value: string) => void }> = ({ value, onChange }) => {
    ...
    return <InputTextarea ref={inputRef} onChange={(e) => onChange(e.target.value)} />;
};
